...
ABOUT = (
    ...
    "• <b>Packages</b> — exports a manifest of the packages you installed and "
    "reinstalls them after a restore or fresh install (Arch/Debian/Fedora); a "
    "same-manager guardrail keeps a manifest from being imported on a system "
